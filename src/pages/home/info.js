...
export const contentAfterBanner = [
	`
		HG develops automated and sophisticated trading solutions for both retail and institutional Clients. These strategies seek stable capital appreciation in the mid to long term, with a low correlation to the performance of traditional asset classes.
	`,
	`
